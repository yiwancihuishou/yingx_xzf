    ...
    <script>
        ...
        $(function () {
            ...
            $.extend($.validator.messages, {
                ...
                minlength: $.validator.format("<span style='color: #cd0a0a'>最少要输入 {4} 个字符</span>"),
            });
            /*异步提交表单*/
            $("#loginButtonId").click(function(){
                ...
                if(isOK){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        data:$("#loginForm").serialize(),//序列化获取表单数据  根据name属性
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required minlength="4"type="test" name="enCode" id="form-code">
                            </div>
